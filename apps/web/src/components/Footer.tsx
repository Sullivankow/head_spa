...
type FooterProps = { readonly onManageCookies: () => void; readonly onOpenPrivacy: () => void };

export function Footer({ onManageCookies, onOpenPrivacy }: FooterProps) {
    return <footer className="border-t border-black/5 px-5 py-10">
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-5 text-xs text-black/50 sm:flex-row sm:items-center">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
                ...
                <span>© 2026 · Tous droits réservés · Mentions légales</span>
